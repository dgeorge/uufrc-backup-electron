...
While the app is in "testing" mode, an authenticated user's refresh token will expire after 7 days. To remove that restruction, the application must be published. I haven't attepted the publishing process.
